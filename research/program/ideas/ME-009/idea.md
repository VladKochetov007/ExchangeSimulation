# ME-009 — Minimal ensemble interaction panel

## Question and scope

Which pair/triple interactions persist in a small pinned finite-resource ensemble?

Strongest intended claim: **CAUSAL** (proposed, not established).
A few tested mechanisms and finite weights; no all-policy Cartesian campaign.
...
Policies: [S07](../../policy-catalogue.md#s07), [S10](../../policy-catalogue.md#s10), [S12](../../policy-catalogue.md#s12), [S27](../../policy-catalogue.md#s27).
...
Required measurement/opportunity contract: Population-conditioned objective/risk outcomes with main effects and declared unmeasured interactions.

Dependencies: [ME-001](../ME-001/idea.md), [ME-006](../ME-006/idea.md), [ME-008](../ME-008/idea.md).
...
- HISTORY: [research/v2-4-liability-hedger-l0-results.md](../../../../research/v2-4-liability-hedger-l0-results.md). Use its own run/config/analyzer identity and verdict; do not relabel as current-main evidence.
...
Pairwise results need not transfer to an ensemble; this does not rescue SV1D.

## Tentative design and next action

Choose a fractional panel only after its component studies have interpretable outcomes.
