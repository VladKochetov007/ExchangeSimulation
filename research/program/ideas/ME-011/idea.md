# ME-011 — Restricted response and invasion graph

## Question and scope

What restricted responses or invasion relations follow from reliable population-conditioned payoffs?

Strongest intended claim: **GAME-THEORETIC** (proposed, not established).
No global equilibrium claim; use full population context, not automatic pairwise matrix substitution.
...
Dependencies: [ME-008](../ME-008/idea.md), [ME-009](../ME-009/idea.md).
These are readiness dependencies, not authorization to run ancestors.

## Historical evidence and limits

- HISTORY: [research/market-ecology-next-study-brief.md](../../../../research/market-ecology-next-study-brief.md). Use its own run/config/analyzer identity and verdict; do not relabel as current-main evidence.

Non-transitivity does not demonstrate capital cycles; untested policy space remains explicit.

## Tentative design and next action

Specify a finite policy/resource class and uncertainty after payoff readiness.
