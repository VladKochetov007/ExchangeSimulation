...
`artifacts/v2-4-l1p/l1p-summary.json`. Its large descriptive phase contrast
was followed, without tuning, by the preregistered L1-P2 2×2 decomposition in
[`v2-4-l1p2-noise-phase-results.md`](v2-4-l1p2-noise-phase-results.md) and
`artifacts/v2-4-l1p2/l1p2-summary.json`. Both paired seeds meet the registered
aligned-greater-than-dealigned and positive-interaction criteria, supporting a
narrow relative-phase contribution from broad `noise_flow_*` timing to this
local gap endpoint. Absolute phase still differs within the aligned arms, so
this does not identify a unique LCM mechanism or ecology-wide timing
robustness. Before any L2 allocation/demotion, replicate the exact 2×2 on
