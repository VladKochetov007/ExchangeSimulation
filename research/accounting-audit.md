...
outside it or from another participant. Per asset:
    ...
    ExternalIn + InternalNet + ExchangeTake + OpenLinearValue = 0

- **ExternalIn** — deposits and borrowing, the only legitimate creation.
...
| Fee ledger against fee-revenue stream | agree exactly, per asset |
...
| Balance changes self-consistent | 29,455,811 deltas checked, 0 whose reported delta disagrees with their own before and after |
