...
expect_status valid-control-negative VIABLE_DEVELOPMENT_CANDIDATE true true true true true true
expect_status valid-treatment-negative NON-VIABLE_AT_24H_MARKET_SURVIVAL_GATE true true false true true true
expect_status invalid-control-measurement INVALID_DEVELOPMENT_EVIDENCE true false true true true true
expect_status invalid-treatment-measurement INVALID_DEVELOPMENT_EVIDENCE true false false true true true
expect_status invalid-mechanical-evidence INVALID_DEVELOPMENT_EVIDENCE false true true true true true
expect_status invalid-cdf-audit INVALID_DEVELOPMENT_EVIDENCE true true true true false true
