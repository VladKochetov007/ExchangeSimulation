(
	...
	($all_cells_valid and $all_measurements_valid and $all_paired_effect_valid and
		(($all_cdf_contract_valid and $all_anticheating_valid) or
		 ($terminal_failure_seen and $all_terminal_diagnostic_valid))) as $evidence_valid |
	{
		viable: $viable,
		evidence_valid: $evidence_valid,
		terminal_failure_seen: $terminal_failure_seen,
		terminal_diagnostic_valid: $all_terminal_diagnostic_valid,
