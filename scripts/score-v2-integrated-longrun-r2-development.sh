...
for cell in dev-607 dev-613 dev-617; do
	...
	jq -e --arg cell "$cell" --argjson required_artifacts "$required_json" \
		...
		.analysis_contract == "v2-integrated-longrun-r2-candidate-v1" and
		.integrity_contract == "v2-integrated-longrun-r2-candidate-v1" and
		.activation_contract == "v2-integrated-longrun-r2-candidate-v1" and
