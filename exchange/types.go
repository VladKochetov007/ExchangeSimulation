...
type MarginInterestAccrualEvent = etypes.MarginInterestAccrualEvent
type MarginInterestRemainderClosedEvent = etypes.MarginInterestRemainderClosedEvent
...
type PositionRoundingEvent = etypes.PositionRoundingEvent
...
type PositionAccountingDelta = etypes.PositionAccountingDelta
